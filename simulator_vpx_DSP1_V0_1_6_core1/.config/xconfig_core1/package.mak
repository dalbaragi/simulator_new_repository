...
package/%.xdc.inc package/%_xconfig_core1.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_core1" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: core1.pe66

-include package/cfg/core1_pe66.mak
-include package/cfg/core1_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/core1_pe66.dep
endif
core1.pe66: package/cfg/core1_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
core1.pe66 package/cfg/core1_pe66.c: .libraries,e66
endif

package/cfg/core1_pe66.c package/cfg/core1_pe66.h package/cfg/core1_pe66.xdl: override _PROG_NAME := core1.xe66
package/cfg/core1_pe66.c: package/cfg/core1_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/core1_pe66.cfg
	-$(RM) package/cfg/core1_pe66.dep
	-$(RM) package/cfg/core1_pe66.c
	-$(RM) package/cfg/core1_pe66.xdc.inc

clean,e66::
	-$(RM) core1.pe66
.executables,e66 .executables: core1.xe66

core1.xe66: |core1.pe66

-include package/cfg/core1.xe66.mak
core1.xe66: package/cfg/core1_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/core1_pe66.oe66   package/cfg/core1_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
core1.xe66: export C_DIR=
core1.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
core1.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

core1.test test,e66 test: core1.xe66.test

core1.xe66.test:: core1.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 core1.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.core1.xe66, ) 
endif
...
clean,e66::
	-$(RM) core1.xe66
clean:: 
	-$(RM) package/cfg/core1_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
core1_pe66.oe66,copy : package/cfg/core1_pe66.oe66
core1_pe66.se66,copy : package/cfg/core1_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_core1
xconfig_core1.tar: package/package.bld.xml
xconfig_core1.tar: package/package.ext.xml
xconfig_core1.tar: package/package.rel.dot
xconfig_core1.tar: package/build.cfg
xconfig_core1.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_core1.tar.dep
endif
package/rel/xconfig_core1/xconfig_core1/package/package.rel.xml:

xconfig_core1.tar: package/rel/xconfig_core1.xdc.inc package/rel/xconfig_core1/xconfig_core1/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_core1.xdc.inc,package/rel/xconfig_core1.tar.dep)


release release,xconfig_core1: all xconfig_core1.tar
clean:: .clean
	-$(RM) xconfig_core1.tar
	-$(RM) package/rel/xconfig_core1.xdc.inc
	-$(RM) package/rel/xconfig_core1.tar.dep
